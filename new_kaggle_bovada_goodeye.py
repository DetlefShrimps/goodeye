...
!pip3 install dask-ml[complete] dask[complete] tqdm schedules datetime xgboost optuna torch openpyxl python-mlb-statsapi lolcat pybaseball pandas numpy requests joblib scikit-learn flask
