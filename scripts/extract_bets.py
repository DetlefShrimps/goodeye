...
class BovadaScraper:
    ...
    def extract_unique_bet_names(self, events):
        unique_bet_names = set()
        for event in events:
            for market in event['markets']:
                unique_bet_names.add(market['market_key'])
        return unique_bet_names
    ...
    def scrape_bovada(self):
        ...
        if mlb_bets:
            ...
            unique_bet_names = self.extract_unique_bet_names(mlb_bets)
            print("Unique bet names:")
            for name in unique_bet_names:
                print(name)
        else:
